...
import com.example.yuvish.databinding.KvitansiyaItem2Binding

class ViewPagerAdapter2(var onItemClick: OnItemClick, var list: ArrayList<String>) :
    RecyclerView.Adapter<ViewPagerAdapter2.Vh>() {

    inner class Vh(val binding: KvitansiyaItem2Binding) : RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewPagerAdapter2.Vh {
        return Vh(KvitansiyaItem2Binding.inflate(LayoutInflater.from(parent.context), parent, false))
    }

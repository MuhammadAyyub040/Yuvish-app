...
class NotSizedProductsAdapter(
    ...
    interface CallBack{
        fun sizedClickListener(productId: Int, productSize: ProductSize)
        fun printClickListener(sizingProduct: SizingProduct)
    }

    inner class FirstHolder(val binding: NotsizedproductfirstitemBinding): RecyclerView.ViewHolder(binding.root){
        ...
        private fun finishSizing(sizingProduct: SizingProduct){
            ...
            if (volume == 0.0){
                ...
                callBack.sizedClickListener(sizingProduct.id, productSize)
            }
        }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return if (viewType == 0) {
            FirstHolder(
                NotsizedproductfirstitemBinding.inflate(
